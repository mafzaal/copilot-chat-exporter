...
try:
    from copilot_chat_exporter import CopilotChatExporter, ChatMessage, ChatSession
    print("✅ Successfully imported CopilotChatExporter")
except ImportError as e:
    print(f"❌ Failed to import CopilotChatExporter: {e}")
    sys.exit(1)
...
def test_workspace_functionality():
    ...
    try:
        from workspace_finder import VSCodeWorkspaceFinder
